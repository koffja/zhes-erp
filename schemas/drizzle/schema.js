...
const products = sqliteTable('products', {
  ...
  bulkPrice: real('bulk_price'),
  superBulkPrice: real('super_bulk_price'),
  createdAt: text('created_at').default(new Date().toISOString())
});

const productAliases = sqliteTable('product_aliases', {
  id: integer('id').primaryKey({ autoIncrement: true }),
...
const productsNew = sqliteTable('products_new', {
  id: integer('id').primaryKey({ autoIncrement: true }),
...
const productSpecs = sqliteTable('product_specs', {
  id: integer('id').primaryKey({ autoIncrement: true }),
  productId: integer('product_id').notNull(),
...
const productPrices = sqliteTable('product_prices', {
  id: integer('id').primaryKey({ autoIncrement: true }),
